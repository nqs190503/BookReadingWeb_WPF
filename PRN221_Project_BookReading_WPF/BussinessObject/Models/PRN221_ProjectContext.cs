...
namespace BussinessObject.Models
{
    public partial class PRN221_ProjectContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //                optionsBuilder.UseSqlServer("Data Source=DESKTOP-MTJTVNI\\SQLEXPRESS;Initial Catalog=PRN221_Project; Trusted_Connection=SSPI;Encrypt=false;TrustServerCertificate=true");
            //            }
